export default class ResponsiveMenu {
  ...
  // Constructor
    ...
    this.submenuToggles = this.menu.getElementsByClassName(this.options.submenuToggleClass);
  ...
  _isMobile() {
    ...
    let isMobile = 'none' === window.getComputedStyle(this.menuToggle, null).getPropertyValue('display') ? false : true;
    return isMobile;
  }
